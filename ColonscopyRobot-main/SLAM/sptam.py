...
if __name__ == '__main__':
    ...
    from params import ParamsKITTI, ParamsEuroc, ParamsColon
    from dataset import KITTIOdometry, EuRoCDataset, ColonDataset
    ...
    elif args.dataset.lower() == 'colon':
        params = ParamsColon()
        dataset = ColonDataset(args.path)
